# TOOLS — agent-runtime-designer-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `ux-strategy` | Concrete tool implementing the `ux-strategy` capability | Operator implements when needed |
| `design-critique` | Concrete tool implementing the `design-critique` capability | Operator implements when needed |
| `prototyping-guide` | Concrete tool implementing the `prototyping-guide` capability | Operator implements when needed |
