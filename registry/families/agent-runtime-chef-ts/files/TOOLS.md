...
| `recipe-development` | Concrete tool implementing the `recipe-development` capability | Operator implements when needed |
| `technique-guidance` | Concrete tool implementing the `technique-guidance` capability | Operator implements when needed |
