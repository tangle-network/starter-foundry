# TOOLS — agent-runtime-relationship-coach-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `check-in-protocol` | Concrete tool implementing the `check-in-protocol` capability | Operator implements when needed |
| `communication-tool-practice` | Concrete tool implementing the `communication-tool-practice` capability | Operator implements when needed |
| `conflict-pattern-naming` | Concrete tool implementing the `conflict-pattern-naming` capability | Operator implements when needed |
