# TOOLS — agent-runtime-legal-counsel-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `contract-redline` | Concrete tool implementing the `contract-redline` capability | Operator implements when needed |
| `nda-review` | Concrete tool implementing the `nda-review` capability | Operator implements when needed |
| `msa-review` | Concrete tool implementing the `msa-review` capability | Operator implements when needed |
| `escalation-protocol` | Concrete tool implementing the `escalation-protocol` capability | Operator implements when needed |
