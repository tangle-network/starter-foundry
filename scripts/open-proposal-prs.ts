...
//
// Usage:
//   node scripts/open-proposal-prs.ts --kind capability [--min-confidence 0.75]
//   node scripts/open-proposal-prs.ts --kind family [--min-confidence 0.75]
//
...
function renderBody(kind, proposal) {
  ...
  return [
    ...
    '',
    '### Review checklist',
    '- [ ] Manifest validates (`node scripts/validate-registry.ts`)',
