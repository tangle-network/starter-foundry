# TOOLS — agent-runtime-history-tutor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `source-analysis` | Concrete tool implementing the `source-analysis` capability | Operator implements when needed |
| `historiographic-debate` | Concrete tool implementing the `historiographic-debate` capability | Operator implements when needed |
| `timeline-reasoning` | Concrete tool implementing the `timeline-reasoning` capability | Operator implements when needed |
