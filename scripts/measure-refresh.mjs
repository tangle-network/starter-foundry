...
//
// Usage:
//   node scripts/measure-refresh.mjs           # run what's stale, emit summary
//   node scripts/measure-refresh.mjs --dry-run # report drift only, don't write
//   node scripts/measure-refresh.mjs --force   # rerun all stages regardless
//
// Exit codes:
...
const STAGES = [
  {
    ...
    script: 'scripts/analyze-buildouts.mjs',
  ...
  },
  {
    ...
    script: 'scripts/infer-capability-gaps.mjs',
  ...
  {
    name: 'replay-traces',
    script: 'scripts/replay-traces.mjs',
  ...
  },
  {
    ...
    script: 'scripts/refresh-scorecard.mjs',
