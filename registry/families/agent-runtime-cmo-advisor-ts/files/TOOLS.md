# TOOLS — agent-runtime-cmo-advisor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `positioning-strategy` | Concrete tool implementing the `positioning-strategy` capability | Operator implements when needed |
| `channel-experiment-design` | Concrete tool implementing the `channel-experiment-design` capability | Operator implements when needed |
| `icp-research` | Concrete tool implementing the `icp-research` capability | Operator implements when needed |
