# TOOLS — agent-runtime-chemistry-research-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `literature-search` | Concrete tool implementing the `literature-search` capability | Operator implements when needed |
| `reaction-planning` | Concrete tool implementing the `reaction-planning` capability | Operator implements when needed |
| `compound-data-extraction` | Concrete tool implementing the `compound-data-extraction` capability | Operator implements when needed |
