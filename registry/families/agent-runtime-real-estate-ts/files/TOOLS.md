# TOOLS — agent-runtime-real-estate-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `comp-analysis` | Concrete tool implementing the `comp-analysis` capability | Operator implements when needed |
| `cap-rate-worksheet` | Concrete tool implementing the `cap-rate-worksheet` capability | Operator implements when needed |
| `offer-strategy` | Concrete tool implementing the `offer-strategy` capability | Operator implements when needed |
