...
// Menu-bar popover preview: same index.html / app bundle as production,
// just served over HTTP instead of the Tauri webview so humans can see
// the compact panel layout at its native 320x400 size.
