...
//
// CI invocation:
//   ANTHROPIC_API_KEY=... node scripts/template-quality-sweep.mjs --top 5
//   # or fall back to TANGLE_ROUTER_USER_KEY
// Local dry-run:
//   node scripts/template-quality-sweep.mjs --top 3 --dry-run
...
if (!existsSync(ANALYSIS)) {
  console.error('✗ .evolve/buildout-analysis.json missing. Run `node scripts/run-buildout-pipeline.mjs` first.')
  process.exit(2)
}
