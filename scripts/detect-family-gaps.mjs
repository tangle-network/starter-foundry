...
//
// Usage:
//   node scripts/detect-family-gaps.mjs              # print top-10 gaps
//   node scripts/detect-family-gaps.mjs --json       # machine-readable
//   node scripts/detect-family-gaps.mjs --top 20     # configurable top-N
//   node scripts/detect-family-gaps.mjs --min-count 3 # require N occurrences
...
if (JSON_OUT) {
  ...
  console.log('  node scripts/detect-family-gaps.mjs --json | node scripts/propose-family-candidates.mjs')
}
