...
interface JudgeInput {
   ...
   * Generated by scripts/family-pass-rate-trend.mjs. */
  familyId?: string
}
...
function loadRecentTrend(familyId: string): { slope: number; latestRate: number; weeks: number } | null {
...
export function judge(input: JudgeInput): JudgeResult {
  ...
  // See scripts/family-pass-rate-trend.mjs for the data source.
