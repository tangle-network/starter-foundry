...
| Tool | Intent | Notes |
|---|---|---|
| `medical-reference` | Concrete tool implementing the `medical-reference` capability | Operator implements when needed |
| `symptom-explainer` | Concrete tool implementing the `symptom-explainer` capability | Operator implements when needed |
| `treatment-overview` | Concrete tool implementing the `treatment-overview` capability | Operator implements when needed |
