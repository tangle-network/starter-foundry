# TOOLS — agent-runtime-security-engineer-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `threat-modeling` | Concrete tool implementing the `threat-modeling` capability | Operator implements when needed |
| `vulnerability-triage` | Concrete tool implementing the `vulnerability-triage` capability | Operator implements when needed |
| `security-architecture-review` | Concrete tool implementing the `security-architecture-review` capability | Operator implements when needed |
