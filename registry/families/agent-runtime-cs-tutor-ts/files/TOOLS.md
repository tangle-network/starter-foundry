# TOOLS — agent-runtime-cs-tutor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `explain-concept` | Concrete tool implementing the `explain-concept` capability | Operator implements when needed |
| `debug-code` | Concrete tool implementing the `debug-code` capability | Operator implements when needed |
| `generate-exercise` | Concrete tool implementing the `generate-exercise` capability | Operator implements when needed |
