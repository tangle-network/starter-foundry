# TOOLS — agent-runtime-account-executive-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `opportunity-scoring` | Concrete tool implementing the `opportunity-scoring` capability | Operator implements when needed |
| `deal-progression` | Concrete tool implementing the `deal-progression` capability | Operator implements when needed |
| `pipeline-review` | Concrete tool implementing the `pipeline-review` capability | Operator implements when needed |
