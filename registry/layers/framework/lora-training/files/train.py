...
Requires TRL >= 0.12 (uses SFTConfig + processing_class API).
"""
...
def main() -> int:
    ...
    # SFTConfig requires a non-None dataset_text_field; "text" is the
    # conventional fallback when formatting_func drives the pipeline instead.
    ...
    # --- Training config (TRL >= 0.12 SFTConfig) ------------------------
    sft_cfg = SFTConfig(
