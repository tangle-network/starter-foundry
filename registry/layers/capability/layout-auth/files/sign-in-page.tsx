      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-primary p-12 text-primary-foreground">
        ...
        <div>
          <blockquote className="text-lg font-medium leading-relaxed opacity-90">
            "This platform completely transformed how our team works. The speed and quality are unmatched."
          </blockquote>
          <p className="mt-4 text-sm opacity-75">— Happy Customer, CEO at Company</p>
        </div>
