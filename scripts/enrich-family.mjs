...
//   - verify:            scripts/audit-scaffold-quality.mjs --layer framework:<family>
//   - review:            LLM via tangle-router, JSON-only, NEVER overturns verify
//
// Usage:
//   TANGLE_ROUTER_USER_KEY=... node scripts/enrich-family.mjs --family hipaa-compliance-pack
//   node scripts/enrich-family.mjs --family <id> --max-shots 3 --builder-model sonnet
