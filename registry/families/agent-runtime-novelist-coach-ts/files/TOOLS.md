# TOOLS — agent-runtime-novelist-coach-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `scene-card-protocol` | Concrete tool implementing the `scene-card-protocol` capability | Operator implements when needed |
| `beat-sheet-review` | Concrete tool implementing the `beat-sheet-review` capability | Operator implements when needed |
| `voice-audit` | Concrete tool implementing the `voice-audit` capability | Operator implements when needed |
