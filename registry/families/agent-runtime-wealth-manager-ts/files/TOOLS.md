# TOOLS — agent-runtime-wealth-manager-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `asset-allocation-review` | Concrete tool implementing the `asset-allocation-review` capability | Operator implements when needed |
| `tax-loss-harvesting` | Concrete tool implementing the `tax-loss-harvesting` capability | Operator implements when needed |
| `retirement-projection` | Concrete tool implementing the `retirement-projection` capability | Operator implements when needed |
| `regulatory-disclaimer` | Concrete tool implementing the `regulatory-disclaimer` capability | Operator implements when needed |
