# TOOLS — agent-runtime-business-partner-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `weekly-review-protocol` | Concrete tool implementing the `weekly-review-protocol` capability | Operator implements when needed |
| `okr-design` | Concrete tool implementing the `okr-design` capability | Operator implements when needed |
| `decision-journal` | Concrete tool implementing the `decision-journal` capability | Operator implements when needed |
