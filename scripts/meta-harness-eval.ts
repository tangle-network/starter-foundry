...
//
// Usage:
//   node scripts/meta-harness-eval.ts --out .evolve/meta-harness/runs/baseline.jsonl
//   node scripts/meta-harness-eval.ts --planner .evolve/meta-harness/variants/foo.js --out ...
//
