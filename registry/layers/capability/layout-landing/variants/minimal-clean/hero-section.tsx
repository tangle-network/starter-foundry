      ...
      <div className="mx-auto max-w-7xl px-6 py-28 sm:py-36 lg:px-8 lg:py-44">
        <div className="mx-auto flex max-w-2xl flex-col items-center text-center">
          ...
          <div className="mt-10 flex items-center gap-4">
            <Button
              size="lg"
              className="h-12 rounded-lg px-8 font-medium transition-all hover:brightness-110 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            >
              Get Started
            </Button>
            <Button
              size="lg"
              variant="ghost"
              className="group h-12 gap-2 rounded-lg px-8 font-medium text-foreground underline decoration-muted-foreground/30 underline-offset-4 transition-all hover:bg-transparent hover:decoration-foreground focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
            >
              Learn more
