...
//
// Usage:
//   node scripts/detect-capability-gaps.mjs              # top-10 gaps
//   node scripts/detect-capability-gaps.mjs --json       # machine-readable
//   node scripts/detect-capability-gaps.mjs --top 5 --min-count 3
...
if (JSON_OUT) {
  ...
  console.log(`  node scripts/detect-capability-gaps.mjs --json --top 3 \\`)
  console.log(`    | node scripts/propose-capability-candidates.mjs`)
}
