...
//
// Usage:
//   node scripts/notify-webhooks.mjs --event family:added --ref <family-id>
//   node scripts/notify-webhooks.mjs --event capability:added --ref <cap-id>
//   node scripts/notify-webhooks.mjs --event cve:bumped --ref <pkg>:<version>
