...
//
// Usage:
//   node scripts/replay-traces.mjs                      # full corpus
//   node scripts/replay-traces.mjs --limit 50           # first 50 traces
//   node scripts/replay-traces.mjs --scenario <id>      # filter by scenarioId
//
