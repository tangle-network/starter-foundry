# TOOLS — agent-runtime-grant-writer-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `grant-proposal-drafting` | Concrete tool implementing the `grant-proposal-drafting` capability | Operator implements when needed |
| `deadline-management` | Concrete tool implementing the `deadline-management` capability | Operator implements when needed |
| `reporting-compliance` | Concrete tool implementing the `reporting-compliance` capability | Operator implements when needed |
