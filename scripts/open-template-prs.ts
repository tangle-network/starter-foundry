...
//
// CI invocation:
//   node scripts/open-template-prs.ts
// Dry-run (no PRs opened):
//   node scripts/open-template-prs.ts --dry-run
    ...
    [
      ...
      [
        ...
        [
          ...
          ``,
          `---`,
          `_Opened by \`scripts/open-template-prs.ts\` — part of the Branch 2 template-quality loop._`,
        ].join('\n'),
      ],
    ],
    ['git', ['checkout', '-']],
