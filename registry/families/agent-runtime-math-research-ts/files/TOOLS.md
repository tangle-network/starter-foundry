# TOOLS — agent-runtime-math-research-ts
...
| `proof-verification` | Concrete tool implementing the `proof-verification` capability | Operator implements when needed |
| `mathematical-reasoning` | Concrete tool implementing the `mathematical-reasoning` capability | Operator implements when needed |
