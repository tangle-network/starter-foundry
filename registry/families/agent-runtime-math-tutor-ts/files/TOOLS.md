# TOOLS — agent-runtime-math-tutor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `problem-generation` | Concrete tool implementing the `problem-generation` capability | Operator implements when needed |
| `step-by-step-solution` | Concrete tool implementing the `step-by-step-solution` capability | Operator implements when needed |
| `concept-explanation` | Concrete tool implementing the `concept-explanation` capability | Operator implements when needed |
