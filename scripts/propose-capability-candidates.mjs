...
//   node scripts/propose-capability-candidates.mjs --max-iterations 8 --top 1
//   node scripts/propose-capability-candidates.mjs --mode=rlm --max-shots 2
//   node scripts/propose-capability-candidates.mjs --full-boot   # enable scaffold-runs gate
