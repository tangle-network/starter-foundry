...
//
// Usage:
//   node scripts/promote-template.mjs --family threejs-game
//   node scripts/promote-template.mjs --all                         # every family with a library dir
//   node scripts/promote-template.mjs --all --dry-run               # score without copying
//   node scripts/promote-template.mjs --family X --top 5            # keep top 5 pool (default 5)
//
