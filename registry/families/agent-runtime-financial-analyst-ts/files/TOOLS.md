# TOOLS — agent-runtime-financial-analyst-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `financial-modeling` | Concrete tool implementing the `financial-modeling` capability | Operator implements when needed |
| `equity-research` | Concrete tool implementing the `equity-research` capability | Operator implements when needed |
| `investment-memo` | Concrete tool implementing the `investment-memo` capability | Operator implements when needed |
