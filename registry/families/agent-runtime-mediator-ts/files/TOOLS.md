# TOOLS — agent-runtime-mediator-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `structured-dialogue` | Concrete tool implementing the `structured-dialogue` capability | Operator implements when needed |
| `de-escalation-protocol` | Concrete tool implementing the `de-escalation-protocol` capability | Operator implements when needed |
| `agreement-drafting` | Concrete tool implementing the `agreement-drafting` capability | Operator implements when needed |
