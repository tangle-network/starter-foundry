...
| Tool | Intent | Notes |
|---|---|---|
| `incident-response-protocol` | Concrete tool implementing the `incident-response-protocol` capability | Operator implements when needed |
| `runbook-automation` | Concrete tool implementing the `runbook-automation` capability | Operator implements when needed |
| `iac-review` | Concrete tool implementing the `iac-review` capability | Operator implements when needed |
