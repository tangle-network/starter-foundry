 ...
 *
 * Usage:
 *   node scripts/visual-audit.mjs                          # audit all frontend specs
 *   node scripts/visual-audit.mjs --spec /tmp/spec.json    # audit one spec
 *   node scripts/visual-audit.mjs --family react-vite-ts   # audit one family
 */
