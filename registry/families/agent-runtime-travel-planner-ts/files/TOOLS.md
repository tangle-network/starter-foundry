# TOOLS — agent-runtime-travel-planner-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `itinerary-design` | Concrete tool implementing the `itinerary-design` capability | Operator implements when needed |
| `budget-optimization` | Concrete tool implementing the `budget-optimization` capability | Operator implements when needed |
| `logistics-check` | Concrete tool implementing the `logistics-check` capability | Operator implements when needed |
