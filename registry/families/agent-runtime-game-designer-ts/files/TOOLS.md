# TOOLS — agent-runtime-game-designer-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `mechanic-design` | Concrete tool implementing the `mechanic-design` capability | Operator implements when needed |
| `narrative-system-design` | Concrete tool implementing the `narrative-system-design` capability | Operator implements when needed |
| `player-loop-design` | Concrete tool implementing the `player-loop-design` capability | Operator implements when needed |
