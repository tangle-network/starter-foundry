# TOOLS — agent-runtime-recruiter-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `jd-drafting` | Concrete tool implementing the `jd-drafting` capability | Operator implements when needed |
| `screening-rubric-design` | Concrete tool implementing the `screening-rubric-design` capability | Operator implements when needed |
| `interview-loop-design` | Concrete tool implementing the `interview-loop-design` capability | Operator implements when needed |
