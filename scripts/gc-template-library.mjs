...
//
// Usage:
//   node scripts/gc-template-library.mjs                 # dry-run, keep 20 top
//   node scripts/gc-template-library.mjs --apply         # actually archive
//   node scripts/gc-template-library.mjs --keep 10 --apply
//   node scripts/gc-template-library.mjs --family X --keep 5 --apply
