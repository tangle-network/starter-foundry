# TOOLS — agent-runtime-college-counselor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `application-strategy` | Concrete tool implementing the `application-strategy` capability | Operator implements when needed |
| `essay-coaching` | Concrete tool implementing the `essay-coaching` capability | Operator implements when needed |
| `financial-aid-navigation` | Concrete tool implementing the `financial-aid-navigation` capability | Operator implements when needed |
