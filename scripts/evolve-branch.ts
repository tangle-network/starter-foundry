...
//
// Usage:
//   ANTHROPIC_API_KEY=... node scripts/evolve-branch.ts
//   node scripts/evolve-branch.ts --concurrency 3 --max-shots 3
//   node scripts/evolve-branch.ts --only hipaa-compliance-pack,threejs-game
//   node scripts/evolve-branch.ts --skip esp32-rust,stm32-rust     # slow toolchains
