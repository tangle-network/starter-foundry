# TOOLS — agent-runtime-illustrator-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `art-direction` | Concrete tool implementing the `art-direction` capability | Operator implements when needed |
| `style-development` | Concrete tool implementing the `style-development` capability | Operator implements when needed |
| `composition-guide` | Concrete tool implementing the `composition-guide` capability | Operator implements when needed |
