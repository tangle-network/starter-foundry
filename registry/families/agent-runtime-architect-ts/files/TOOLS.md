# TOOLS — agent-runtime-architect-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `system-design` | Concrete tool implementing the `system-design` capability | Operator implements when needed |
| `trade-off-analysis` | Concrete tool implementing the `trade-off-analysis` capability | Operator implements when needed |
| `architecture-decision-record` | Concrete tool implementing the `architecture-decision-record` capability | Operator implements when needed |
