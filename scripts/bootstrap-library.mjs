...
//
// Usage:
//   node scripts/bootstrap-library.mjs          # all passing families
//   node scripts/bootstrap-library.mjs --dry-run
//   node scripts/bootstrap-library.mjs --only threejs-game,bevy-web
