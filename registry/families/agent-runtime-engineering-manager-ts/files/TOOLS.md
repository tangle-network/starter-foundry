# TOOLS — agent-runtime-engineering-manager-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `1:1-cadence` | Concrete tool implementing the `1:1-cadence` capability | Operator implements when needed |
| `sprint-planning` | Concrete tool implementing the `sprint-planning` capability | Operator implements when needed |
| `incident-postmortem` | Concrete tool implementing the `incident-postmortem` capability | Operator implements when needed |
| `tech-debt-triage` | Concrete tool implementing the `tech-debt-triage` capability | Operator implements when needed |
