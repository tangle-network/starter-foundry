...
const FAMILY_PROMPTS: Record<string, string> = {
  ...
  "fhenix-contracts": "Build a Fhenix FHE encrypted contract",
...
const CAP_PROMPTS: Record<string, { prompt: string; family: string }> = {
  ...
  "capability:dashboard-layout": { prompt: "Build a dashboard with sidebar navigation", family: "fullstack-ts" },
  ...
  "capability:move-launchpad": { prompt: "Build a Move token sale platform on Aptos with vesting", family: "move-contracts" },
  ...
  "capability:move-staking": { prompt: "Build an Aptos staking rewards platform", family: "move-contracts" },
