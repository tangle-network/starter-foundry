 ...
 *
 * Usage:
 *   node scripts/sync-warm-list.ts                    # print missing deps
 *   node scripts/sync-warm-list.ts --write             # update the warm list in place
 *   node scripts/sync-warm-list.ts --agent-dev-path /path/to/agent-dev-container
 *
