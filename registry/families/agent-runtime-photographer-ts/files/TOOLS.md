# TOOLS — agent-runtime-photographer-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `composition-coaching` | Concrete tool implementing the `composition-coaching` capability | Operator implements when needed |
| `lighting-setup-design` | Concrete tool implementing the `lighting-setup-design` capability | Operator implements when needed |
| `post-production-workflow` | Concrete tool implementing the `post-production-workflow` capability | Operator implements when needed |
