...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <header className="sticky top-0 z-50 bg-gradient-to-r from-violet-600 via-blue-600 to-cyan-500 shadow-lg dark:from-violet-900 dark:via-blue-900 dark:to-cyan-800">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6 lg:px-8">
          <span className="text-lg font-semibold text-white">{'{{headline}}'}</span>
          <nav className="hidden items-center gap-6 text-sm text-white/80 md:flex">
            <a href="#features" className="transition-colors hover:text-white">Features</a>
            <a href="#pricing" className="transition-colors hover:text-white">Pricing</a>
            <a href="/sign-in" className="transition-colors hover:text-white">Sign in</a>
          </nav>
          <Button size="sm" variant="ghost" className="text-white hover:bg-white/10 md:hidden" asChild>
