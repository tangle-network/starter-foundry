# TOOLS — agent-runtime-therapist-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `peer-support-listening` | Concrete tool implementing the `peer-support-listening` capability | Operator implements when needed |
| `phq9-screener` | Concrete tool implementing the `phq9-screener` capability | Operator implements when needed |
| `gad7-screener` | Concrete tool implementing the `gad7-screener` capability | Operator implements when needed |
| `crisis-escalation` | Concrete tool implementing the `crisis-escalation` capability | Operator implements when needed |
