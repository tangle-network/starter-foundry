...
//
// Usage:
//   node scripts/self-heal.mjs                         # dry-run (prints proposals, no dispatch)
//   node scripts/self-heal.mjs --dispatch              # actually spawn Kimi sessions
//   node scripts/self-heal.mjs --top 1 --dispatch      # only dispatch the single highest-impact proposal
//   node scripts/self-heal.mjs --min-impact 3          # skip low-impact clusters
