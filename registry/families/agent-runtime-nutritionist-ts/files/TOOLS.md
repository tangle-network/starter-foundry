# TOOLS — agent-runtime-nutritionist-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `meal-planning` | Concrete tool implementing the `meal-planning` capability | Operator implements when needed |
| `macro-targeting` | Concrete tool implementing the `macro-targeting` capability | Operator implements when needed |
| `dietary-assessment` | Concrete tool implementing the `dietary-assessment` capability | Operator implements when needed |
