# TOOLS — agent-runtime-language-tutor-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `daily-conversation-prompt` | Concrete tool implementing the `daily-conversation-prompt` capability | Operator implements when needed |
| `vocabulary-drill` | Concrete tool implementing the `vocabulary-drill` capability | Operator implements when needed |
| `shadowing-protocol` | Concrete tool implementing the `shadowing-protocol` capability | Operator implements when needed |
