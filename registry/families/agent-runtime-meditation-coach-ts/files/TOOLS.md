# TOOLS — agent-runtime-meditation-coach-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `guided-session` | Concrete tool implementing the `guided-session` capability | Operator implements when needed |
| `technique-cue` | Concrete tool implementing the `technique-cue` capability | Operator implements when needed |
| `mindfulness-check` | Concrete tool implementing the `mindfulness-check` capability | Operator implements when needed |
