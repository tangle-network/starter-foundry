...
//
// Usage:
//   node scripts/capture-visual-golden.ts           # capture fresh goldens
//   node scripts/capture-visual-golden.ts --check   # compare against committed
//   node scripts/capture-visual-golden.ts --specs specs/golden/*.json
