...
const FAMILY_PROMPTS: Record<string, string> = {
  ...
  "agent-swarm-ts": "Build a LangGraph-js typescript multi-agent swarm with supervisor and specialist worker agents",
  ...
  "electron-native-os": "Build an Electron app with native OS integration, deep links, and OS notifications",
  ...
  "healthcare-hipaa-backend": "Build a HIPAA-compliant healthcare backend for patient records with PHI audit logging",
  ...
  "realtime-audio-ts": "Build a realtime audio visualization with WebAudio analyser and WebRTC peer connection",
  "sglang-server": "Build an SGLang inference server with radix attention and constrained generation",
  ...
  "voice-first-agent": "Build a voice-first conversational agent with browser mic and speech to text",
  ...
  "ecommerce-headless": "Build a headless commerce backend with cart checkout and Stripe payment intent webhooks",
  ...
  "hipaa-compliance-pack": "Add a HIPAA-compliant compliance pack with PHI audit trail and BAA template",
...
const CAP_PROMPTS: Record<string, { prompt: string; family: string }> = {
  ...
  "capability:agent-multi-agent": { prompt: "Build a langchain AI agent with sub-agent delegation and agent-as-tool patterns", family: "agent-service-ts" },
  ...
  "capability:move-amm": { prompt: "Build a Sui Move DEX with swap routing and pool curves", family: "move-contracts" },
  "capability:move-launchpad": { prompt: "Build a Sui Move token launchpad with vesting schedules", family: "move-contracts" },
  "capability:move-nft": { prompt: "Build a Sui Move NFT marketplace with auctions", family: "move-contracts" },
  "capability:move-oracle": { prompt: "Build a Sui Move oracle with Pyth price feeds", family: "move-contracts" },
  "capability:move-staking": { prompt: "Build a Sui Move staking rewards module with delegation", family: "move-contracts" },
  ...
  "capability:ai-voice-chat": { prompt: "Build a Next.js voice chat interface with STT streaming and tool calls", family: "nextjs-ts" },
  "capability:multi-tenancy": { prompt: "Build a multi-tenant SaaS admin dashboard with per-tenant workspace isolation and subdomain routing", family: "fullstack-ts" },
