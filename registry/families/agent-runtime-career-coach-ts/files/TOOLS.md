# TOOLS — agent-runtime-career-coach-ts
...
| Tool | Intent | Notes |
|---|---|---|
| `self-assessment` | Concrete tool implementing the `self-assessment` capability | Operator implements when needed |
| `market-positioning` | Concrete tool implementing the `market-positioning` capability | Operator implements when needed |
| `decision-framework` | Concrete tool implementing the `decision-framework` capability | Operator implements when needed |
